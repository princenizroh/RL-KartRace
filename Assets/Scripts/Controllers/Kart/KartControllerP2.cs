...
namespace KartRace
{
    public class KartControllerP2 : MonoBehaviour
    {
        ...
        {
            float wheelAngle = Input.GetAxis("Horizontal_P2") * maxWheelTurnAngle;
            float steerAngle = Input.GetAxis("Horizontal_P2") * maxSteeringWheelAngle;
            // Wheel Rotation
